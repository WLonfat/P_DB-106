...
LOAD DATA INFILE '/scripts/DATA/CSV/t_client.csv'
INTO TABLE t_client
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_article.csv'
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_livreur.csv'
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_adresse.csv'
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_livraison.csv'
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_commande.csv'
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_paiement.csv'
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_lignecommande.csv'
...
-- Tables de liaison
LOAD DATA INFILE '/scripts/DATA/CSV/t_vivre.csv'
INTO TABLE t_vivre
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_livrer.csv'
INTO TABLE t_livrer
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/scripts/DATA/CSV/t_avoir.csv'
INTO TABLE t_avoir
CHARACTER SET utf8mb4
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\n'
